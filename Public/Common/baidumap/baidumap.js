document.write("<script language='javascript' src='http://api.map.baidu.com/api?key=&v=1.4&services=true'></script>");
function baiduMap(markerArr,bMap){
	//标注点数组
	this.markerArr = markerArr;
    //markerArr = [{title:"我的标记",content:"我的备注",point:"114.033159|22.538665",isOpen:1,icon:{w:22,h:22,l:0,t:22,x:6,lb:5}}];
